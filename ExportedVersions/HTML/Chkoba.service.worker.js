...
/** @type {string} */
const CACHE_VERSION = '1767224037|7002077437';
/** @type {string} */
const CACHE_PREFIX = 'Chkoba-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Chkoba.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Chkoba.html","Chkoba.js","Chkoba.offline.html","Chkoba.icon.png","Chkoba.apple-touch-icon.png","Chkoba.audio.worklet.js","Chkoba.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Chkoba.wasm","Chkoba.pck"];
